...
**Package**: an R package is an extension to the R language. It contains code, data and documentation and acts as a series of additional tools that you can use in R. A useful methaphor is that R packages are like special tools that you can add to the main toolbox of R.
